...
bindEvents: function() {
  ...
  createProperty: function(event) {
    ...
    var PropOwner = $('#PropAdd #PropLoc').val();
    ...
    if (error) {
       ...
       App.contracts.asset.createProperty(PropId, PropVal, PropLoc, PropOwner, {gas: 1000000, 
  ...
  rejectProperty: function(event) {
    ...
    App.contracts.asset.rejectProperty(PropId, {gas: 1000000, 
    						gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
    		if(!error)
                console.log(JSON.stringify(result));
            else
  ...
  reqchangeOwnership: function(event) {
   ...
   App.contracts.asset.changeOwnership(PropId, NewOwner, {gas: 1000000, 
   							gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
    		if(!error)
            	console.log(JSON.stringify(result));
            else
  ...
  approveChangeOwnership: function(event) {
    ...
    App.contracts.asset.approveChangeOwnership(PropId, {gas: 1000000, 
    						gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
        	if(!error)
                console.log(JSON.stringify(result));
            else
  ...
  changeValue: function(event) {
    ...
    App.contracts.asset.changeValue(PropId, NewVal, {gas: 1000000, 
    						gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
        	if(!error)
                console.log(JSON.stringify(result));
            else
  ...
  //  event.preventDefault();
    ...
    App.contracts.asset.getPropertyDetails(PropId, {gas: 1000000, 
    						gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
  	if(!error)
    {
    console.log(JSON.stringify(result));
  ...
  adduser: function(event) {
    ...
    {App.contracts.asset.addNewUser(useraddress, {gas: 1000000, 
    	        gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
    if(!error)
        console.log(result);
    else
    ...
    {App.contracts.asset.addNewAdmin(useraddress, {gas: 1000000, 
    			gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
    if(!error)
    console.log(JSON.stringify(result));
    else
    ...
    {App.contracts.asset.addNewSuperAdmin(useraddress, {gas: 1000000, 
    				gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
    if(!error)
    console.log(JSON.stringify(result));
    else
